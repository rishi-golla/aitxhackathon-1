...
export default function AccidentsCard() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1">
        ...
        {/* Bars */}
        <div className="flex items-end justify-between gap-1.5 h-full relative">
          {data.map((item, i) => {
            const height = (item.value / max) * 100
            const isHighlight = item.day === 'Sa' || item.day === 'Fr'
            const isWeekend = item.day === 'Sa' || item.day === 'Su'

            return (
              <div key={item.day} className="flex flex-col items-center gap-1.5 flex-1 group">
                <motion.div
                  ...
                  className="relative w-full rounded-t-md cursor-pointer overflow-hidden"
                  style={{
                    minHeight: '3px',
                  }}
                >
                  ...
                  <div 
                    ...
                    style={{
                      background: isHighlight 
                        ...
                        : isWeekend
                        ? 'linear-gradient(180deg, rgba(61,219,217,0.85) 0%, rgba(0,245,204,0.85) 100%)'
                        : 'linear-gradient(180deg, rgba(61,219,217,0.7) 0%, rgba(0,245,204,0.7) 100%)',
                      boxShadow: isHighlight 
                        ? '0 0 16px rgba(61,219,217,0.5), inset 0 1px 0 rgba(255,255,255,0.2)'
                        : '0 0 8px rgba(61,219,217,0.3), inset 0 1px 0 rgba(255,255,255,0.15)',
                    }}
                  />
                  ...
                  <motion.div
                    ...
                    style={{
                      background: 'radial-gradient(circle at center, rgba(61,219,217,0.4) 0%, transparent 70%)',
                    }}
                  />
                </motion.div>
                ...
                <motion.span 
                  ...
                  className="text-[9px] font-medium text-zinc-500 group-hover:text-zinc-400 transition-colors"
                >
                  {item.day}
                </motion.span>
              </div>
