...
try:
    ...
    import sys
    print("Warning: pyds not found, using mock", file=sys.stderr)
    class MockPyds:
        def gst_buffer_get_nvds_batch_meta(self, batch): return None
    pyds = MockPyds()
...
class VideoFileFrameGetter:
    ...
    def _create_pipeline(
        ...
        if videoconvert is None:
            import sys
            print("Warning: nvvideoconvert not found, using videoconvert", file=sys.stderr)
